...
function SelectionMark() {
  return (
    <span
      className="membership-choice__mark"
      aria-hidden="true"
    >
...
function MembershipCard({ selected, onSelect, location, className, style, children, ...rest }: MembershipCardProps) {
  return (
    <button
      ...
      className={`${className} membership-choice relative w-full text-left`}
      style={style}
      {...rest}
    >
      {children}
        ...
        <div className="grid lg:grid-cols-2 gap-6 md:gap-10 mt-5 md:mt-6">
          ...
          <div data-reveal-group>
            ...
            <button
              ...
              className="membership-choice conic-ring relative block w-full text-left bg-[rgba(69,240,166,.07)] border border-[rgba(69,240,166,.35)] rounded-card px-4 md:px-6 py-3 mb-3 transition-all duration-300 hover:bg-[rgba(69,240,166,.11)]"
              data-reveal
              style={{ '--i': 1 } as React.CSSProperties}
            >
